  ...
  return (
    <div className="">
      ...
      <main className="flex flex-col h-screen w-screen justify-center items-center overflow-hidden relative">
        ...
        <div className="z-20 w-4/5 lg:w-1/2 xl:w-1/3 bg-white absolute right-5 bottom-20 md:bottom-64 lg:right-80 xl:right-1/4 lg:bottom-28 xl:bottom-1/4  shadow-md lg:p-12 xl:p-16 xl:h-1/3 rounded">
          ...
          <button className=" m-3 transition-colors duration-500 transform bg-green-dark hover:bg-green-light hover:text-green-dark text-white  font-semibold  xl:text-2xl rounded "><div className="p-3 px-8 mr-12">Why choose Hyve?</div> <div className="absolute -bottom-3 right-0  "><div class="w-12  overflow-hidden inline-block">
            <div class=" h-24  bg-white rotate-12 transform origin-bottom-left"></div>
          </div></div></button>
